...
save_path1 = "newsgroups6_label0.csv"
read_path1 = 'newsgroups6_prelabel0.csv'
...
read_path2 = './datasets/TextClassification/newsgroups6/test.csv'
f_2 = open("newsgroups6_test.csv", 'w', encoding='utf-8')
...
with open('newsgroups6_label0.csv', 'r', encoding='utf-8') as fa:
    with open('newsgroups6_test.csv', 'r', encoding='utf-8') as fb:
        with open('newsgroups6_pre0.csv', 'w', encoding='utf-8') as fc:
            for line in fa:
                fc.write(line.strip('\r\n'))
                fc.write(',')
...
save_path2 = "newsgroups6_test0.csv"
save_path3 = "newsgroups6_testall.csv"
read_path3 = 'newsgroups6_pre0.csv'
...
os.remove("newsgroups6_label0.csv")
os.remove("newsgroups6_test.csv")
os.remove("newsgroups6_pre0.csv")
