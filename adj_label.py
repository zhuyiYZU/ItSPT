# 调整位置后数据
f_1 = open("newsgroups6_test.csv", 'w', encoding='utf-8')
with open('newsgroups6_testall.csv', 'r', encoding='utf-8') as t:
...
for i in range(1, 11):
    read_path = "newsgroups6_prelabel" + str(i) + ".csv"
    save_path = "newsgroups6_prelabel_" + str(i) + ".csv"
...
# 先将0改为-1，用0覆盖训练集
read_path1 = 'newsgroups6_test0.csv'
m = 0
n = 0
...
j = m
for i in range(1, 11):
    save_path = "newsgroups6_label" + str(i) + ".csv"
    f_2 = open(save_path, 'w', encoding='utf-8')
    read_path2 = "newsgroups6_prelabel_" + str(i) + ".csv"
    print('-----------')
...
for i in range(1, 11):
    os.remove("newsgroups6_prelabel_" + str(i) + ".csv")
